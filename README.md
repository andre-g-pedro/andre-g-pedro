...
|-------------|----------|
|✔️📊[Industry Wages](https://github.com/andre-g-pedro/industry-wages)|This dashboard provides average salary data by industry, allowing for easy comparison of wage levels across regions and sectors, and showing a trend analysis over multiple years.|
